...
class ModelLoader:
    ...
    def load_yolo(self):
        ...
        if os.path.exists(yolo_path):
            ...
            print("Loaded YOLOv8 base model (yolov8n.pt)")
    ...
    def predict_image(self, image_path):
        """Predict on a single image and perform detection"""
        ...
        if self.yolo_model:
            ...
            result_image_path = os.path.join(app.config['RESULTS_FOLDER'], result_filename)
            ...
            for r in results:
                ...
                for box in boxes:
                    ...
                    # Draw on image
                    color = (0, 255, 0) if "bird" in label.lower() else (0, 0, 255)
        ...
        if predictions:
            ...
            return {
                ...
                'result_image': f"/results/{os.path.basename(result_image_path)}" if result_image_path else None
            }
